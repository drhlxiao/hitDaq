...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.statusTab)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.statusTreeWidget = QtWidgets.QTreeWidget(self.statusTab)
        self.statusTreeWidget.setObjectName("statusTreeWidget")
        self.verticalLayout_5.addWidget(self.statusTreeWidget)
        self.statusUpdateInfoLabel = QtWidgets.QLabel(self.statusTab)
        self.statusUpdateInfoLabel.setObjectName("statusUpdateInfoLabel")
        self.verticalLayout_5.addWidget(self.statusUpdateInfoLabel)
        self.readStatusButton = QtWidgets.QPushButton(self.statusTab)
        self.readStatusButton.setObjectName("readStatusButton")
        self.verticalLayout_5.addWidget(self.readStatusButton)
        self.registerContainerTab.addTab(self.statusTab, "")
        ...
        spacerItem6 = QtWidgets.QSpacerItem(491, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.gridLayout.addItem(spacerItem7, 1, 5, 1, 2)
        ...
        spacerItem10 = QtWidgets.QSpacerItem(711, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem10, 3, 3, 1, 4)
        ...
        spacerItem11 = QtWidgets.QSpacerItem(20, 372, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
...
"background-color: rgb(239, 41, 41);")
        ...
        self.registerContainerTab.setCurrentIndex(2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.readStatusButton.setText(_translate("MainWindow", "Read Status"))
        self.registerContainerTab.setTabText(self.registerContainerTab.indexOf(self.statusTab), _translate("MainWindow", "Status"))
