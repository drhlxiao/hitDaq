...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.registerAddressInput = QtWidgets.QLineEdit(
            self.registerReadWriteTab)
        ...
        self.registerValueInput = QtWidgets.QLineEdit(
            self.registerReadWriteTab)
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.registerListGroup.sizePolicy().hasHeightForWidth())
        ...
        spacerItem3 = QtWidgets.QSpacerItem(
            400, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.waveformUpdatePeriodInput = QtWidgets.QDoubleSpinBox(
            self.tabScience)
        ...
        self.waveformUpdatePeriodInput.setObjectName(
            "waveformUpdatePeriodInput")
        ...
        self.selectArchiveFolderButton.setMaximumSize(
            QtCore.QSize(100, 16777215))
        self.selectArchiveFolderButton.setObjectName(
            "selectArchiveFolderButton")
        self.gridLayout.addWidget(self.selectArchiveFolderButton, 0, 5, 1, 1)
        spacerItem4 = QtWidgets.QSpacerItem(
            491, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.archiveFilenamePrefixInput.setMaximumSize(
            QtCore.QSize(500, 16777215))
        self.archiveFilenamePrefixInput.setObjectName(
            "archiveFilenamePrefixInput")
        self.gridLayout.addWidget(self.archiveFilenamePrefixInput, 1, 1, 1, 4)
        spacerItem5 = QtWidgets.QSpacerItem(
            578, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.archiveFilesizeMaxInput.setMaximumSize(
        ...
        spacerItem6 = QtWidgets.QSpacerItem(
            578, 27, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem8 = QtWidgets.QSpacerItem(
            711, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem9 = QtWidgets.QSpacerItem(
            20, 372, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.currentArchiveFilenameLabel.setObjectName(
            "currentArchiveFilenameLabel")
        self.gridLayout_2.addWidget(
            self.currentArchiveFilenameLabel, 1, 2, 1, 1)
        ...
        MainWindow.addDockWidget(
            QtCore.Qt.DockWidgetArea(8), self.dockWidget_3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.openScriptButton.setToolTip(_translate(
            "MainWindow", "Open a script to execute"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tabControls), _translate("MainWindow", "Configuration"))
        self.registerContainerTab.setTabText(self.registerContainerTab.indexOf(
            self.registerReadTab), _translate("MainWindow", "Register Read"))
        ...
        self.registerListGroup.setTitle(_translate(
            "MainWindow", "Select a register to read/write"))
        self.registerContainerTab.setTabText(self.registerContainerTab.indexOf(
            self.registerReadWriteTab), _translate("MainWindow", "Register Read/Write"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tabRegisters), _translate("MainWindow", "Registers"))
        self.waveformGroupBox.setTitle(_translate("MainWindow", "Waveform"))
        self.label_13.setText(_translate("MainWindow", "Update period(s)"))
        self.drs4SingleReadButton.setText(
            _translate("MainWindow", "Single-shot read"))
        self.drs4ContinousReadButton.setText(
            _translate("MainWindow", "Continuous read"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tabScience), _translate("MainWindow", "Science"))
        ...
        self.selectArchiveFolderButton.setText(
            _translate("MainWindow", "Select..."))
        self.label_7.setText(_translate("MainWindow", "Filename prefix:"))
        self.archiveFilenamePrefixInput.setText(
            _translate("MainWindow", "daq_"))
        ...
        self.enableArchingButton.setText(
            _translate("MainWindow", "Enable Archiving"))
        self.truncateArchivingButton.setText(
            _translate("MainWindow", "Truncate"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tabArchive), _translate("MainWindow", "Archive"))
