...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.tab_controls)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(self.tab_controls)
        ...
        self.selectFolderBtn = QtWidgets.QToolButton(self.groupBox_2)
        self.selectFolderBtn.setMinimumSize(QtCore.QSize(40, 40))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/Icons/images/fileopen.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.selectFolderBtn.setIcon(icon)
        self.selectFolderBtn.setIconSize(QtCore.QSize(30, 30))
        self.selectFolderBtn.setObjectName("selectFolderBtn")
        self.horizontalLayout_5.addWidget(self.selectFolderBtn)
        self.folderLabel = QtWidgets.QLabel(self.groupBox_2)
        ...
        self.folderLabel.setMinimumSize(QtCore.QSize(500, 0))
        ...
        self.horizontalLayout_2.addWidget(self.initBtn)
        ...
        self.horizontalLayout_2.addWidget(self.readStatBtn)
        ...
        self.horizontalLayout_2.addWidget(self.lastCmdBtn)
        self.tempReadBtn = QtWidgets.QPushButton(self.groupBox_4)
        self.tempReadBtn.setObjectName("tempReadBtn")
        self.horizontalLayout_2.addWidget(self.tempReadBtn)
        ...
        self.listWidget = QtWidgets.QListWidget(self.tab_controls)
        ...
        spacerItem7 = QtWidgets.QSpacerItem(518, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "Working directory"))
        self.selectFolderBtn.setToolTip(_translate("MainWindow", "select working directory"))
        self.selectFolderBtn.setText(_translate("MainWindow", "..."))
        ...
        self.tempReadBtn.setText(_translate("MainWindow", "Read Temp."))
