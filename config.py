...
commands = {
            ...
            },
        {
            ...
            'sequence': [
                ('get_register', 0x21, "Reading the temperature from I2C device 0x90"),
                ('get_register', 0x22, "Reading the temperature from I2C device 0x92"),
                ],
            },
        {
            'name': 'read_status',
        ...
        'readoutsGroup':
...

          {
                ...
                'type': 'inline',
                'inputs':[{'name':'ROI_delay_input','button_title':'ROI delay','type':'int', 'default':200},
                    {'name':'ROI_length_input','button_title':'Read length','type':'int', 'default':100},
                    ],
                'sequence':   [
                ...
                },
        {
                ...
                'inputs':[{'name':'smart_read_length','button_title':'Smart read length','type':'int', 'default':100, 'colspan':1},
                    {'name':'smart_read_start_cell','button_title':'Smart read start cell','type':'int', 'default':300,'colspan':1},
                    ],
                'sequence': [
...

        {
                ...
                'type': 'row',
                'tooltip': 'burst read ',
                'inputs':[{'type':'int','name':'nb_burst_reads','button_title':'Nb. of reads','default':100,'colspan':2}],
