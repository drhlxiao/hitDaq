                    ...
                    },
                {
                    ...
                    'sequence': [
                        (('_sequence_read', '_decode_temp'), (0x21,),
                            "Reading the temperature from I2C device "),
                        (('_sequence_read', '_decode_temp'), (0x22,),
                            "Reading the temperature from I2C device "),  # callback
                        ],
                    },
                {
                        'name': 'read_status',
        ...
        'readoutsGroup':
        {
            ...
            'sequences': [
                    ...
                    },
                {
                    ...
                    'inputs': [
                        {'name': 'smart_read_readout mode', 'tooltip': 'Readout mode',
                            'type': 'int', 'default': 2, 'colspan': 1, 'max': 65535},
                        {'name': 'smart_readout_channels', 'tooltip': 'Smart read-out channels(0x81)',
                            'type': 'int', 'default': 100, 'colspan': 1, 'max': 65535},
                        {'name': 'smart_read_length', 'tooltip': 'Smart read length (Reg 0x83)',
                            'type': 'int', 'default': 100, 'colspan': 1, 'max': 65535},
                        {'name': 'smart_read_start_cell', 'tooltip': 'Smart read start cell (Reg 0x84)',
...
readouts={
        'widgets': ['readoutLabel1', 'readoutInput1', 
            'readoutLabel2', 'readoutInput2',
            'readoutLabel3', 'readoutInput3'],
        'visible':[
        ...
        'name':
        [
            ('Readout channels', '0x01FF', '', '','', ''), 
            ('Readout channels', '0x01FF', 'Delay', '0x00C8','Length', '100'), 
            ('Readout channels', '0x01FF', 'Readout start', '300','Length', '100'), 
            ],
        'address':[
            (None, 0x81, None, None, None, None),
            (None, 0x81, None, 0x82, None, 0x83),
            (None, 0x81, None, 0x84, None, 0x83),
            ]
        }
